<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelaTrade.aspx.cs" Inherits="Web_After.BasicManager.DataRela.RelaTrade" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        var common_data_trade_decl = [], common_data_trade_insp = [];
        var store_trade_decl, store_trade_insp;
        ...
        Ext.onReady(function () {
            Ext.Ajax.request({
                ...
                success: function (response, option) {
                    ...
                    common_data_trade_decl = commondata.DECLTRADE;//
                    common_data_trade_insp = commondata.INSPTRADE;//
                    store_trade_decl = Ext.create('Ext.data.JsonStore', { fields: ['CODE', 'NAME'], data: common_data_trade_decl });
                    store_trade_insp = Ext.create('Ext.data.JsonStore', { fields: ['CODE', 'NAME'], data: common_data_trade_insp });
        ...
        function init_search() {
            var searchCode = Ext.create('Ext.form.field.Text', { id: 'DECLTRADECODE', name: 'DECLTRADECODE', fieldLabel: '报关贸易方式代码' });
            var searchName = Ext.create('Ext.form.field.Text', { id: 'DECLTRADENAME', name: 'DECLTRADENAME', fieldLabel: '报关贸易方式名称' });
        ...
        function gridbind() {
            var store_customer = Ext.create('Ext.data.JsonStore',
                {
                    fields: ['DECLTRADE', 'DECLTRADENAME', 'INSPTRADE', 'INSPTRADENAME', 'ENABLED', 'STARTDATE', 'CREATEMANNAME',
                        'CREATEDATE', 'STOPMANNAME', 'ENDDATE', 'REMARK', 'ID'],
                    pageSize: 20,
                    proxy: {
                        type: 'ajax',
                        url: 'RelaTrade.aspx?action=loadData',
                        reader: {
                            root: 'rows',
                            type: 'json',
                            totalProperty: 'total'
            ...
            var gridpanel = Ext.create('Ext.grid.Panel', {
                ...
                columns: [
                    ...
                    { header: '报关贸易方式代码', dataIndex: 'DECLTRADE', width: 150 },
                    { header: '报关贸易方式名称', dataIndex: 'DECLTRADENAME', width: 150 },
                    { header: '报检贸易方式代码', dataIndex: 'INSPTRADE', width: 150 },
                    { header: '报检贸易方式名称', dataIndex: 'INSPTRADENAME', width: 150 },
        ...
        function form_ini_win() {
            ...
            var store_for_decl = Ext.create('Ext.data.JsonStore', {
                fields: ['CODE', 'NAME'],
                data: common_data_trade_decl
            });

            var store_for_insp = Ext.create('Ext.data.JsonStore', {
                fields: ['CODE', 'NAME'],
                data: common_data_trade_insp
            });
        ...
        function importexcel(action) {
            ...
            var radio_module = Ext.create('Ext.form.RadioGroup', {
                ...
                items: [
                    { boxLabel: "<a href='/FileUpload/rela_trade.xls'><b>模板</b></a>", name: 'RADIO_MODULE', inputValue: '1', checked: true }
                ]
            });
        ...
        function exportdata() {
            var DECLTRADECODE = Ext.getCmp('DECLTRADECODE').getValue();
            var DECLTRADENAME = Ext.getCmp('DECLTRADENAME').getValue();
            var combo_ENABLED_S = Ext.getCmp('combo_ENABLED_S').getValue();
            var path = 'RelaPackage.aspx?action=export&DECLTRADECODE=' + DECLTRADECODE + '&DECLTRADENAME=' + DECLTRADENAME + '&combo_ENABLED_S=' + combo_ENABLED_S;
