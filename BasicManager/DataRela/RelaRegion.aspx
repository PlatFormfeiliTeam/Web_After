<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelaRegion.aspx.cs" Inherits="Web_After.BasicManager.DataRela.RelaRegion" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        var common_data_region_decl = [], common_data_region_insp = [];
        var store_region_decl, store_region_insp;
        ...
        Ext.onReady(function () {
            Ext.Ajax.request({
                ...
                success: function (response, option) {
                    ...
                    common_data_region_decl = commondata.DECLREGION;//
                    common_data_region_insp = commondata.INSPREGION;//
                    store_region_decl = Ext.create('Ext.data.JsonStore', { fields: ['CODE', 'NAME'], data: common_data_region_decl });
                    store_region_insp = Ext.create('Ext.data.JsonStore', { fields: ['CODE', 'NAME'], data: common_data_region_insp });
        ...
        function init_search() {
            var searchCode = Ext.create('Ext.form.field.Text', { id: 'DECLREGIONCODE', name: 'DECLREGIONCODE', fieldLabel: '报关境内地区代码' });
            var searchName = Ext.create('Ext.form.field.Text', { id: 'DECLREGIONNAME', name: 'DECLREGIONNAME', fieldLabel: '报关境内地区名称' });
        ...
        function gridbind() {
            var store_customer = Ext.create('Ext.data.JsonStore',
                {
                    fields: ['DECLREGION', 'DECLREGIONNAME', 'INSPREGION', 'INSPREGIONNAME', 'ENABLED', 'STARTDATE', 'CREATEMANNAME',
                        'CREATEDATE', 'STOPMANNAME', 'ENDDATE', 'REMARK', 'ID'],
                    pageSize: 20,
                    proxy: {
                        type: 'ajax',
                        url: 'RelaRegion.aspx?action=loadData',
                        reader: {
                            root: 'rows',
                            type: 'json',
                            totalProperty: 'total'
            ...
            var gridpanel = Ext.create('Ext.grid.Panel', {
                ...
                columns: [
                    ...
                    { header: '报关境内地区代码', dataIndex: 'DECLREGION', width: 150 },
                    { header: '报关境内地区名称', dataIndex: 'DECLREGIONNAME', width: 150 },
                    { header: '报检境内地区代码', dataIndex: 'INSPREGION', width: 150 },
                    { header: '报检境内地区名称', dataIndex: 'INSPREGIONNAME', width: 150 },
        ...
        function form_ini_win() {
            ...
            var store_for_decl = Ext.create('Ext.data.JsonStore', {
                fields: ['CODE', 'NAME'],
                data: common_data_region_decl
            });

            var store_for_insp = Ext.create('Ext.data.JsonStore', {
                fields: ['CODE', 'NAME'],
                data: common_data_region_insp
            });
        ...
        function importexcel(action) {
            ...
            var radio_module = Ext.create('Ext.form.RadioGroup', {
                ...
                items: [
                    { boxLabel: "<a href='/FileUpload/rela_region.xls'><b>模板</b></a>", name: 'RADIO_MODULE', inputValue: '1', checked: true }
                ]
            });
        ...
        function exportdata() {
            var DECLREGIONCODE = Ext.getCmp('DECLREGIONCODE').getValue();
            var DECLREGIONNAME = Ext.getCmp('DECLREGIONNAME').getValue();
            var combo_ENABLED_S = Ext.getCmp('combo_ENABLED_S').getValue();
            var path = 'RelaRegion.aspx?action=export&DECLREGIONCODE=' + DECLREGIONCODE + '&DECLREGIONNAME=' + DECLREGIONNAME + '&combo_ENABLED_S=' + combo_ENABLED_S;
