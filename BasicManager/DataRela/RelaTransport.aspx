<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelaTransport.aspx.cs" Inherits="Web_After.BasicManager.DataRela.RelaTransport" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        var common_data_transport_decl = [], common_data_transport_insp = [];
        var store_transport_decl, store_transport_insp;
        ...
        Ext.onReady(function () {
            Ext.Ajax.request({
                ...
                success: function (response, option) {
                    ...
                    common_data_transport_decl = commondata.DECTRANSPORT;//
                    common_data_transport_insp = commondata.INSPTRANSPORT;//
                    store_transport_decl = Ext.create('Ext.data.JsonStore', { fields: ['CODE', 'NAME'], data: common_data_transport_decl });
                    store_transport_insp = Ext.create('Ext.data.JsonStore', { fields: ['CODE', 'NAME'], data: common_data_transport_insp });
        ...
        function init_search() {
            var searchCode = Ext.create('Ext.form.field.Text', { id: 'DECLTRANSPORTCODE', name: 'DECLTRANSPORTCODE', fieldLabel: '运输方式代码' });
            var searchName = Ext.create('Ext.form.field.Text', { id: 'DECLTRANSPORTNAME', name: 'DECLTRANSPORTNAME', fieldLabel: '运输方式名称' });
        ...
        function gridbind() {
            var store_customer = Ext.create('Ext.data.JsonStore',
                {
                    fields: ['DECLTRANSPORT', 'DECLTRANSPORTNAME', 'INSPTRANSPORT', 'INSPTRANSPORTNAME', 'ENABLED', 'STARTDATE', 'CREATEMANNAME',
                        'CREATEDATE', 'STOPMANNAME', 'ENDDATE', 'REMARK', 'ID'],
                    pageSize: 20,
                    proxy: {
                        type: 'ajax',
                        url: 'RelaTransport.aspx?action=loadData',
                        reader: {
                            root: 'rows',
                            type: 'json',
                            totalProperty: 'total'
            ...
            var gridpanel = Ext.create('Ext.grid.Panel', {
                ...
                columns: [
                    ...
                    { header: '报关运输方式代码', dataIndex: 'DECLTRANSPORT', width: 150 },
                    { header: '报关运输方式名称', dataIndex: 'DECLTRANSPORTNAME', width: 150 },
                    { header: '报检运输方式代码', dataIndex: 'INSPTRANSPORT', width: 150 },
                    { header: '报检运输方式名称', dataIndex: 'INSPTRANSPORTNAME', width: 150 },
