<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelaCompanyNature.aspx.cs" Inherits="Web_After.BasicManager.DataRela.RelaCompanyNature" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var common_data_companynature_decl = [], common_data_companynature_insp = [];
        var store_companynature_decl, store_companynature_insp;

        Ext.onReady(function () {
            Ext.Ajax.request({
                url: 'RelaCompanyNature.aspx',
                params: { action: 'Ini_Base_Data' },
                type: 'Post',
                success: function (response, option) {
                    var commondata = Ext.decode(response.responseText);
                    common_data_companynature_decl = commondata.DECLCOMPANYNATURE;//
                    common_data_companynature_insp = commondata.INSPCOMPANYNATURE;//
                    store_companynature_decl = Ext.create('Ext.data.JsonStore', { fields: ['CODE', 'NAME'], data: common_data_companynature_decl });
                    store_companynature_insp = Ext.create('Ext.data.JsonStore', { fields: ['CODE', 'NAME'], data: common_data_companynature_insp });
        ...
        function init_search() {
            var searchCode = Ext.create('Ext.form.field.Text', { id: 'DECLCOMPANYNATURECODE', name: 'DECLCOMPANYNATURECODE', fieldLabel: '报关企业性质代码' });
            var searchName = Ext.create('Ext.form.field.Text', { id: 'DECLCOMPANYNATURENAME', name: 'DECLCOMPANYNATURENAME', fieldLabel: '报关企业性质名称' });
        ...
        function gridbind() {
            var store_customer = Ext.create('Ext.data.JsonStore',
                {
                    fields: ['DECLCOMPANYNATURE', 'DECLCOMPANYNATURENAME', 'INSPCOMPANYNATURE', 'INSPCOMPANYNATURENAME', 'ENABLED', 'STARTDATE', 'CREATEMANNAME',
                        'CREATEDATE', 'STOPMANNAME', 'ENDDATE', 'REMARK', 'ID'],
                    pageSize: 20,
                    proxy: {
                        type: 'ajax',
                        url: 'RelaCompanyNature.aspx?action=loadData',
                        reader: {
                            root: 'rows',
                            type: 'json',
                            totalProperty: 'total'
            ...
            var gridpanel = Ext.create('Ext.grid.Panel', {
                ...
                columns: [
                    ...
                    { header: '报关公司性质代码', dataIndex: 'DECLCOMPANYNATURE', width: 150 },
                    { header: '报关公司性质名称', dataIndex: 'DECLCOMPANYNATURENAME', width: 150 },
                    { header: '报检公司性质代码', dataIndex: 'INSPCOMPANYNATURE', width: 150 },
                    { header: '报检公司性质名称', dataIndex: 'INSPCOMPANYNATURENAME', width: 150 },
        ...
        function form_ini_win() {
            ...
            var store_for_decl = Ext.create('Ext.data.JsonStore', {
                fields: ['CODE', 'NAME'],
                data: common_data_companynature_decl
            });

            var store_for_insp = Ext.create('Ext.data.JsonStore', {
                fields: ['CODE', 'NAME'],
                data: common_data_companynature_insp
            });

            var field_Code = Ext.create('Ext.form.field.ComboBox', {
                id: 'DECLCOMPANYNATURE',
                name: 'DECLCOMPANYNATURE',
            ...
            var field_Name = Ext.create('Ext.form.field.ComboBox', {
                id: 'INSPCOMPANYNATURE',
                name: 'INSPCOMPANYNATURE',
        ...
        function importexcel(action) {
            ...
            var radio_module = Ext.create('Ext.form.RadioGroup', {
                ...
                items: [
                    { boxLabel: "<a href='/FileUpload/rela_companynature.xls'><b>模板</b></a>", name: 'RADIO_MODULE', inputValue: '1', checked: true }
                ]
            });
        ...
        function exportdata() {
            var DECLCOMPANYNATURECODE = Ext.getCmp('DECLCOMPANYNATURECODE').getValue();
            var DECLCOMPANYNATURENAME = Ext.getCmp('DECLCOMPANYNATURENAME').getValue();
            var combo_ENABLED_S = Ext.getCmp('combo_ENABLED_S').getValue();
            var path = 'RelaCompanyNature.aspx?action=export&DECLCOMPANYNATURECODE=' + DECLCOMPANYNATURECODE + '&DECLCOMPANYNATURENAME=' + DECLCOMPANYNATURENAME + '&combo_ENABLED_S=' + combo_ENABLED_S;
