    ...
    <script type="text/javascript">
        ...
        function form_ini_win() {
            ...
            var store_for_decl = Ext.create('Ext.data.JsonStore', {
                fields: ['CODE', 'NAME'],
                data: common_data_package_decl
            });

            var store_for_insp = Ext.create('Ext.data.JsonStore', {
                fields: ['CODE', 'NAME'],
                data: common_data_package_insp
            });
        ...
        function importexcel(action) {
            ...
            var radio_module = Ext.create('Ext.form.RadioGroup', {
                ...
                items: [
                    { boxLabel: "<a href='/FileUpload/rela_package.xls'><b>模板</b></a>", name: 'RADIO_MODULE', inputValue: '1', checked: true }
                ]
            });
        ...
        function exportdata() {
            var DECLPACKAGECODE = Ext.getCmp('DECLPACKAGECODE').getValue();
            var DECLPACKAGENAME = Ext.getCmp('DECLPACKAGENAME').getValue();
            var combo_ENABLED_S = Ext.getCmp('combo_ENABLED_S').getValue();
            var path = 'RelaPackage.aspx?action=export&DECLPACKAGECODE=' + DECLPACKAGECODE + '&DECLPACKAGENAME=' + DECLPACKAGENAME + '&combo_ENABLED_S=' + combo_ENABLED_S;
