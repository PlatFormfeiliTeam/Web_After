    ...
    <script type="text/javascript">
        ...
        function importexcel(action) {
            ...
            var radio_module = Ext.create('Ext.form.RadioGroup', {
                ...
                items: [
                    { boxLabel: "<a href='/FileUpload/rela_country.xls'><b>模板</b></a>", name: 'RADIO_MODULE', inputValue: '1', checked: true }
                ]
            });
        ...
        function exportdata() {
            var DECLCOUNTRYCODE = Ext.getCmp('DECLCOUNTRYCODE').getValue();
            var DECLCOUNTRYNAME = Ext.getCmp('DECLCOUNTRYNAME').getValue();
            var combo_ENABLED_S = Ext.getCmp('combo_ENABLED_S').getValue();
            var path = 'RelaCountry.aspx?action=export&DECLCOUNTRYCODE=' + DECLCOUNTRYCODE + '&DECLCOUNTRYNAME=' + DECLCOUNTRYNAME + '&combo_ENABLED_S=' + combo_ENABLED_S;
