<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Base_ciqcode.aspx.cs" Inherits="Web_After.BasicManager.InspInfor.Base_ciqcode" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        //查询条件页面布局和控件（CIQ代码库，启用时间，是否启用）
        function init_search() {
            
            var ciqCodeBase = Ext.create('Ext.form.field.Text', { id: 'CiqCodeBase', name: 'CiqCodeBase', fieldLabel: 'CIQ代码库' });
            ...
            var CiqDataBase = Ext.create('Ext.data.JsonStore',
                {
                    ...
                    proxy: {
                        type: 'ajax',
                        url: 'Base_ciqcode.aspx?action=loadData',
                        reader: {
                            root: 'rows',
                            type: 'json',
                            totalProperty: 'total'
        ...
        function editCustomer() {
            ...
            Ext.Ajax.request({
                url: 'Base_ciqcode.aspx',
                type: 'Post',
                params: { action: 'change', formdata: formdata }
            });
        }
