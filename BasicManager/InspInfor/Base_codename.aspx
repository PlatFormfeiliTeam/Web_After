<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Base_codename.aspx.cs" Inherits="Web_After.BasicManager.InspInfor.Base_codename" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        //特殊监管区：sys_reguareatype 贸易方式：base_tradeway
            ...
            var store_customer = Ext.create('Ext.data.JsonStore',
                {
                    ...
                    proxy: {
                        type: 'ajax',
                        url: 'Base_codename.aspx?action=loadData&table='+param,
                        reader: {
                            root: 'rows',
                            type: 'json',
                            totalProperty: 'total'
        ...
        function exportdata(param) {
            ...
            var path = 'Base_codename.aspx?action=export&CODE_S=' + CODE_S + '&CNNAME_S=' + CNNAME_S +  '&combo_ENABLED_S=' + combo_ENABLED_S + '&table=' + param;
